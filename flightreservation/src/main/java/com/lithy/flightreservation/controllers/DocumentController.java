...
import com.lithy.flightreservation.repos.DocumentRepository;
...
public class DocumentController {
	...
	public String uploadDocument(@RequestParam("document") MultipartFile multipartFile, ModelMap modelMap) {
